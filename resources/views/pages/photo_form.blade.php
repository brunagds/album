    ...
    <div class="col-12">
      <div class="card shadow bg-white rounded">
        ...
        <div class="card-body p-4">
          <form action="/photos" method="POST"> @csrf
            <div class="row">
              <!-- Coluna da foto -->
              <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group"> <label for="title">Título</label>
                  <div class="input-group">
                    <div class="input-group-text"> <i class="fas fa-image"></i> </div> <input id="title" name="title"
                      type="text" class="form-control" placeholder="Digite o título da sua imagem">
                  </div>
                </div> <!-- Data -->
                ...
                <div class="form-group mt-3"> <label for="description">Descrição</label> <textarea id="description"
                    ...
                    placeholder="Digite uma pequena descrição da imagem"></textarea> </div> <!-- Botões -->
